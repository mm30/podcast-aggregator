...
class PodCastsTests(TestCase):
    def setUp(self):
        self.episode = Episode.objects.create(
            ...
            link="https://myawesome.com",
            image="https://myawesome.com",
            podcast_name="My Python Podcast",
            guid="de194720-7b4c-49e2-a05f-432436d3olko",
        )

    def test_episode_content(self):
        self.assertEqual(self.episode.description, "Look, I made it!")
        self.assertEqual(self.episode.link, "https://myawesome.com")
        self.assertEqual(self.episode.guid, "de194720-7b4c-49e2-a05f-432436d3olko")
